...
public interface IAlyzerPlugin {
	 ...
	 */
	default void createFirstPage(GuiScreen gui, IGuiElementHelper elementHelper, IIndividual individual){
	}
	 ...
	 * @param individual The individual that is currently in the alyzer slot.
	 */
	default void createSecondPage(GuiScreen gui, IGuiElementHelper elementHelper, IIndividual individual){
	}
	 ...
	 * @param individual The individual that is currently in the alyzer slot.
	 */
	default void createThirdPage(GuiScreen gui, IGuiElementHelper elementHelper, IIndividual individual){
	}
